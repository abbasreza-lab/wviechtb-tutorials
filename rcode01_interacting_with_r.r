...
# remember: you can run a command from the script by putting the cursor in
# the same line as the command and then hitting the keyboard shortcut:
# - Windows: Ctrl+Enter
# - MacOS:   Command+Enter
...
# the file extension is .txt instead of .r or .R); you can manually change
# the file type at the bottom right corner of the script editor (change it to
# 'R Script') but the more appropriate fix is to change the file extension
# (to .r or .R)
...
# OS to always use RStudio for opening .r (.R) files)
